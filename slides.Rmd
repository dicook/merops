...
* The jitter plot on the left-hand side shows the ratings on different measures for each postcode, faceted by the diseases. Each dot represents a postcode.
]
